(function () {
    ...
    function loadKapa() {
        ...
        script.setAttribute(
            "data-project-logo",
            "https://percona-server-docs-8-4-pr-724.onrender.com/_static/percona-logomark-one-color-dark.png"
        );
    ...
    function init() {
        ...
        // IMPORTANT:
        // Button must exist BEFORE Kapa initializes
        setTimeout(loadKapa, 150);
    }
